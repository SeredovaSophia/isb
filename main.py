import json
from works1 import read_file, read_json, write_to_file
from task1.caesar_cipher1 import caesar_cipher
from task2.task2_func import char_counts, make_key, decrypt_text

def main() -> None:
    """Основная функция программы."""
    try:
        settings = read_json('task1/settings1.json')
        ...
        settings2 = read_json('task2/settings2.json')
        ...
        encrypted_text2 = read_file(input_file2)
